#!/usr/bin/env python3
"""Load schema embeddings using LiteLLM instead of sentence-transformers."""
...
EMBED_MODEL = os.getenv("LITELLM_EMBED_MODEL", "jarvis-embed")
...
def main():
    ...
    conn.close()
    print(f"Successfully inserted {len(all_rows)} embeddings!")
