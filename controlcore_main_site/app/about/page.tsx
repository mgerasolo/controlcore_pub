      ...
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            A modular control system for intelligent automation—designed to sense, think, and act in real-world
            environments.
          </p>
        </div>
        ...
        <Card className="mb-12 border-0 shadow-lg">
          ...
          <CardContent className="space-y-6">
            <p className="text-lg leading-relaxed">
              At its heart is a core logic engine capable of ingesting sensor data, analyzing patterns, making
              contextual decisions, and dispatching targeted actions through connected hardware. It is structured around
              a human-first interface and AI-enhanced planning loop, blending autonomy with oversight.
            </p>
            <div className="grid md:grid-cols-3 gap-6 mt-8">
              <div className="text-center p-6 rounded-lg bg-blue-50 dark:bg-blue-950/20">
                ...
                <p className="text-sm text-muted-foreground">Continuous data ingestion from multiple sensor sources</p>
              </div>
              <div className="text-center p-6 rounded-lg bg-purple-50 dark:bg-purple-950/20">
                ...
                <p className="text-sm text-muted-foreground">AI-enhanced analysis and contextual decision making</p>
              </div>
              <div className="text-center p-6 rounded-lg bg-green-50 dark:bg-green-950/20">
                <Zap className="h-8 w-8 text-green-600 mx-auto mb-3" />
                <h3 className="font-semibold mb-2">Act</h3>
                <p className="text-sm text-muted-foreground">Targeted actions through connected hardware systems</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mb-12 border-0 shadow-lg">
          <CardHeader className="pb-6">
            ...
            <CardDescription className="text-base">
              While our current testbed demonstrates precision irrigation control, the underlying architecture is
              intentionally flexible. ControlCore is engineered to support a wide range of applications:
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="flex items-start gap-4 p-4 rounded-lg border bg-card hover:shadow-md transition-shadow">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Manufacturing and process control systems</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-4 rounded-lg border bg-card hover:shadow-md transition-shadow">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Smart home systems and energy management</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-4 rounded-lg border bg-card hover:shadow-md transition-shadow">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Modular data collection and experimental control</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-4 rounded-lg border bg-card hover:shadow-md transition-shadow">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">AI-assisted analysis of remote sensor networks</p>
                </div>
              </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          <Card className="border-0 shadow-lg">
            ...
            <CardContent className="space-y-4">
              ...
              <p className="leading-relaxed">
                You're viewing the live beta of ControlCore at work. Connected hardware can be controlled through this
                interface, with all decisions running through the central core planner.
              </p>
              <p className="leading-relaxed">
          ...
          <Card className="border-0 shadow-lg">
            ...
            <CardContent className="space-y-4">
              <p className="leading-relaxed">
                The system processes information from user intent or raw sensor data to real-world action through an
                8-node logic engine.
              </p>
              <p className="leading-relaxed">
                Each step is observable, inspectable, and extendable, providing full transparency in the decision-making
                process.
              </p>
              <div className="mt-6">
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-blue-600">Architecture</h3>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-green-600">Interface</h3>
                <ul className="space-y-2 text-muted-foreground">
                  <li className="flex items-start gap-2">
